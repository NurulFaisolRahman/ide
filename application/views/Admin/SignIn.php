                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <ul class="nav nav-pills mb-2 nav-fill" id="pills-tab" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active btn btn-outline-success" id="pills-Masuk-tab" data-toggle="pill" href="#pills-Masuk" role="tab" aria-controls="pills-Masuk" aria-selected="true"><b>ADMIN</b></a>
                          </li>
                        </ul>
    ...
    <script>  
      jQuery(document).ready(function($) {
        ...
        $("#Masuk").click(function() {
          ...
          $.post(BaseURL+"IDE/AdminSignIn", Akun).done(function(Respon) {
            if (Respon == '1') {
